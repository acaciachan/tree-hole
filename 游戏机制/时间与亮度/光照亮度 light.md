...
影响亮度传播的因素：
	...
	天空光亮度衰减量：
		0 : 完全透明
			大部分基本形状(Shape)/轮廓箱(Outline Box) 不完整，且不含水的方块
			还有：玻璃、染色玻璃、(不含水的)屏障、(不含水的)铜网
		
		1 : 散射天空光
			上述的“完全透明”类方块含水后会变为“仅散射天空光”
			还有某些不含水也能散射天空光的方块：
				流体：水，岩浆；
				看起来透光率低的特判方块：粘液块、蜜块，树叶，冰和霜冰，细雪，蜘蛛网，潜影盒，信标，刷怪笼、试炼刷怪笼、宝库；
				管道方块(PipeBlock)：紫颂花、紫颂植物；

		15: 完全遮挡天空光
			“遮挡形状(Occlusion Shape)”为完整方块的方块
			基本为各种完整方块等，还有遮光玻璃
